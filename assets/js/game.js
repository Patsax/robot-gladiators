...
var endGame = function () {
  ...
  if (playerInfo.health > 0) {
    window.alert(
      "Great job, your robot survived the game! You now have a score of " +
        playerInfo.money +
        "."
    );
  } else {
...
var shop = function () {
  ...
  var shopOptionPrompt = window.prompt(
    "Would you like to REFILL " +
      ...
      "'s health, UPGRADE " +
      playerInfo.name +
      "'s attack, or LEAVE the store? Please enter 1 to REFILL, 2 to UPGRADE, or 3 to LEAVE."
  );
...
var playerInfo = {
  ...
  refillHealth: function () {
    if (this.money >= 7) {
      window.alert(
        "Refilling " + playerInfo.name + "'s health by 50 for 7 dollars."
      );
      this.health += 50;
      this.money -= 7;
    } else {
  ...
  upgradeAttack: function () {
    if (this.money >= 7) {
      window.alert(
        "Upgrading" + playerInfo.name + "'s attack by 8 for 7 dollars."
      );
      this.attack += 8;
      this.money -= 7;
    } else {
